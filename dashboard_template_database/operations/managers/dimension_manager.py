...
class DimensionManager(BaseSchemaManager):
    ...
    def convert_to_categorical(self, col_name: str, values: pd.Series) -> bool:
        ...
        try:
            ...
            if not self._convert_fact_table_dimension_mapping(col_name, values_to_labels=False):
    ...
    def batch_update_dimensions(self, dimension_data: Dict[str, pd.Series], 
        ...
        if use_parallel and len(dimension_data) > 1 and self.max_workers > 1:
            ...
            with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
                ...
                future_to_dimension = {
                    executor.submit(self.update_dimension_values, dim_name, values): dim_name
    ...
    def _convert_fact_table_dimension_mapping(self, col_name: str, values_to_labels: bool = True) -> bool:
        """
